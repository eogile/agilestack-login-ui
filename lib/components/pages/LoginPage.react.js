...
function buildState(props) {
  ...
  return { login: login, canLogin: canLogin, open: open, hasError: hasError, callback: callback };
}
...
var LoginPage = function (_Component) {
  ...
  _createClass(LoginPage, [{
    ...
    value: function handleRequestClose() {
      var dispatch = this.props.dispatch;
      var callback = this.props.location.query.callback;
    ...
    value: function render() {
      ...
      var toolbar;
      if (hasError) {
        toolbar = _jsx(_materialUi.Toolbar, {
          style: styles.box
        }, void 0, _jsx('span', {
          style: styles.errorMessages
        }, void 0, ' You provided the wrong username and password, please try again'));
      }
      return _jsx('div', {}, void 0, _ref, _ref2, toolbar, _jsx(_materialUi.Paper, {
        style: styles.box
      ...
      }, void 0, _jsx(_FormsyText2.default, {
      ...
      }, 'login'), _jsx(_FormsyText2.default, {
        name: 'password',
        style: styles.bigField,
        required: true,
...
var connectRedefined = function connectRedefined(state) {
  console.log("state=");
  console.dir(state);
  return state.login;
};
exports.default = (0, _reactRedux.connect)(connectRedefined)(LoginPage);